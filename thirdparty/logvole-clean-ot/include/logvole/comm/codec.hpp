...
#include "logvole/comm/envelope.hpp"
...
#define LOGVOLE_DEFINE_TRIVIAL_MESSAGE_TRAITS(TypeName, PayloadTypeId)                                               \
    template <>                                                                                                        \
    struct logvole::comm::message_traits<TypeName> : logvole::comm::trivial_message_traits<TypeName, PayloadTypeId> \
    {}
