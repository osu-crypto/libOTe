...
public:
	...
	TwoOneSemiHonestSender(size_t fieldBits = 2, size_t numThreads_ = 1) :
...
class TwoOneSemiHonestReceiver :
	...
	private ChunkedSender<TwoOneSemiHonestReceiver, std::tuple<block>, std::tuple<AlignedUnVector<block>>>
{
public:
	using Base = DotSemiHonestReceiver;

	TwoOneSemiHonestReceiver(size_t fieldBits = 2, size_t numThreads_ = 1) :
		Base(fieldBits, numThreads_),
		ChunkerBase(this) {}
