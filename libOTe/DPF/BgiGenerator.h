...
namespace osuCrypto
{
    ...
    public:
        ...
        static void keyGen(span<u8> idx, block val, block seed, span<block> k0, span<block> g0, span<block> k1, span<block> g1);
        static void keyGen(uint128_t idx, block val, block seed, span<block> k0, span<block> g0, span<block> k1, span<block> g1);
    };
