...
| Harden native LogVole tests | 40% | In progress | Factored native assertions into `LogVole_TestUtil.h`; ported keyderive and shrink/expand tests off the GTest shim; added join guards around threaded protocol tests. |
