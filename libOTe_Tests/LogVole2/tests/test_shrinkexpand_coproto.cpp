...
void LogVole2_ShrinkExpandCoproto_TruncOfflineAndExpandBoundedRelation(const oc::CLP&)
{
...
void LogVole2_ShrinkExpandCoproto_FullNoiseTolerance(const oc::CLP&)
{
...
void LogVole2_ShrinkExpandCoproto_OfflineStateReuseAcrossQueries(const oc::CLP&)
{
    const auto params = make_params();
    RingNttContext ctx{};
    LOGVOLE_REQUIRE_TRUE(makeRingNttContext(params.mRing, ctx));
