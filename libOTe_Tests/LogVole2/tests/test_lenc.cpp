...
void LogVole2_LencOps_EncShapeAndDeterminism(const oc::CLP&)
{
...
void LogVole2_LencOps_DigestTreeDeterministic(const oc::CLP&)
{
    const auto params = make_params();
    RingNttContext ctx{};
    LOGVOLE_REQUIRE_TRUE(makeRingNttContext(params.mRing, ctx));
...
void LogVole2_LencOps_EvalMatchesRmulDigestMinusSmulX(const oc::CLP&)
{
    const auto params = make_params();
    RingNttContext ctx{};
    LOGVOLE_REQUIRE_TRUE(makeRingNttContext(params.mRing, ctx));
...
void LogVole2_LencOps_EvalFromPrebuiltTreeMatchesEvalFromX(const oc::CLP&)
{
    const auto params = make_params();
    RingNttContext ctx{};
    LOGVOLE_REQUIRE_TRUE(makeRingNttContext(params.mRing, ctx));
...
void LogVole2_LencOps_EvalRejectsMuMismatch(const oc::CLP&)
{
    const auto params = make_params();
    RingNttContext ctx{};
    LOGVOLE_REQUIRE_TRUE(makeRingNttContext(params.mRing, ctx));
...
void LogVole2_LencOps_TruncEncShapeAndDeterminism(const oc::CLP&)
{
    const auto params = make_params();
    RingNttContext ctx{};
    LOGVOLE_REQUIRE_TRUE(makeRingNttContext(params.mRing, ctx));
...
void LogVole2_LencOps_TruncDigestTreeDeterministic(const oc::CLP&)
{
    const auto params = make_params();
    RingNttContext ctx{};
    LOGVOLE_REQUIRE_TRUE(makeRingNttContext(params.mRing, ctx));
...
void LogVole2_LencOps_TruncEvalFromPrebuiltTreeMatchesEvalFromX(const oc::CLP&)
{
    const auto params = make_params();
    RingNttContext ctx{};
    LOGVOLE_REQUIRE_TRUE(makeRingNttContext(params.mRing, ctx));
...
void LogVole2_LencOps_TruncEvalRejectsMuMismatch(const oc::CLP&)
{
    const auto params = make_params();
    RingNttContext ctx{};
    LOGVOLE_REQUIRE_TRUE(makeRingNttContext(params.mRing, ctx));
...
void LogVole2_LencOps_TruncLeafInputsAreGadgetPath(const oc::CLP&)
{
