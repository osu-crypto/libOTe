...
namespace
{
    ...
    RingParams make_four_limb_params()
    {
        RingParams params{};
        params.mPolyModulusDegree = 1024;
        params.mCoeffModulusBits = { 30, 30, 30, 30 };
        return params;
    }
...
void LogVole2_RingOps_NttRoundTrip(const oc::CLP&)
{
...
void LogVole2_RingOps_GadgetDecomposeRecompose(const oc::CLP&)
{
    const auto params = make_small_params();
    RingNttContext ctx{};
    LOGVOLE_REQUIRE_TRUE(makeRingNttContext(params, ctx));
...
void LogVole2_RingOps_GadgetDecomposeRecomposeBits(const oc::CLP&)
{
    const auto params = make_small_params();
    RingNttContext ctx{};
    LOGVOLE_REQUIRE_TRUE(makeRingNttContext(params, ctx));
...
void LogVole2_RingOps_GadgetDecomposeBitsRangeMatchesSlice(const oc::CLP&)
{
    const auto params = make_small_params();
    RingNttContext ctx{};
    LOGVOLE_REQUIRE_TRUE(makeRingNttContext(params, ctx));
...
void LogVole2_RingOps_CenteredGadgetDecomposeRecomposeBits(const oc::CLP&)
{
...
void LogVole2_RingOps_TensorPackUnpack(const oc::CLP&)
{
    const auto params = make_small_params();
    RingNttContext ctx{};
    LOGVOLE_REQUIRE_TRUE(makeRingNttContext(params, ctx));
...
void LogVole2_RingOps_NonceBatchDeterminism(const oc::CLP&)
{
    const auto params = make_small_params();
    RingNttContext ctx{};
    LOGVOLE_REQUIRE_TRUE(makeRingNttContext(params, ctx));
