...
void LogVole2_KeyDeriveCore_AlgebraicRelation(const oc::CLP&)
{
    run_core_case(0x1110u, 3);
}

void LogVole2_KeyDeriveCore_DeterministicRegressionSeeds(const oc::CLP&)
{
...
void LogVole2_KeyDeriveCore_MetadataMismatchRejected(const oc::CLP&)
{
    const auto params = make_params();
    RingNttContext ctx{};
    LOGVOLE_REQUIRE_TRUE(makeRingNttContext(params, ctx));
